...
fun constructRoute(route: String): String {
    return when {
        route.contains(UrlConstants.BASE_URL_OPEN_FOOD_FACTS) -> route
        route.startsWith("/") -> "${UrlConstants.BASE_URL_OPEN_FOOD_FACTS}$route"
        else -> "${UrlConstants.BASE_URL_OPEN_FOOD_FACTS}/$route"
    }
}